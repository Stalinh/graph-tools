...
import { useExecutiveWorkbenchMotion } from './KnowledgeBase/useExecutiveWorkbenchMotion';
...
export function KnowledgeBaseGraphZone({
  ...
  const graphZoneRef = useRef<HTMLDivElement | null>(null);

  useExecutiveWorkbenchMotion(graphZoneRef);

  return (
    <div className="graph-zone graph-zone--executive" ref={graphZoneRef}>
      <div data-workbench-motion="toolbar">
        <WorkspaceToolbar
      ...
      <div data-workbench-motion="messages">
      ...
      <div className="graph-zone__canvas-wrap" data-workbench-motion="canvas">
        <GraphCanvas
