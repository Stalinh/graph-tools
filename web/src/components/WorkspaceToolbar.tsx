...
export function WorkspaceToolbar({
  ...
  return (
    <div className="workspace-toolbar">
      <div className="workspace-toolbar__status-group">
        <span className="workspace-toolbar__eyebrow">{isZh ? '图谱状态' : 'Graph status'}</span>
      ...
      <div className="workspace-toolbar__filter-group">
        <FilterChips
      ...
      <div className="workspace-toolbar__command-group">
