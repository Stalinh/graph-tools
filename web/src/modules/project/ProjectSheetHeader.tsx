import { Eye, FilePlus, FolderOpen, Pencil, Plus, Save, SaveAll } from 'lucide-react';
    ...
    <header className="project-sheet-page__header">
      ...
      <div className="project-sheet-page__header-actions">
        <div
          ...
          aria-label={isZh ? '编辑模式切换' : 'Edit mode toggle'}
        >
          <button
        ...
        <div
          ...
          aria-label={isZh ? '项目文件操作' : 'Project file actions'}
        >
          <button
